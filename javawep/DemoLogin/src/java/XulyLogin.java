...
public class XulyLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //Lấy user và password từ form đăng nhập
            ...
            {
                 //tạo biến dùng chung cho mọi trang (biến ở phạm vi sesion - toàn bộ phiên làm việc)
            ...
            {
                out.println("<h3>Loi dang nhap</h3>");
                out.println("<p>" + csdl.QLCSDL.getError() + "</p>");
